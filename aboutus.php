...
?>
    ...
    <!-- about start-->
    <!-- Values part -->
    <section class="values-part">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-12">
                    <div class=" text-center" style="padding: 0 0 30px;">
                        <h2>Our Values </h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid bg-light  justify-content-center d-flex">
            <div class="row value">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 value-content">
                    <div class="val-con">
                    <h3>Respect</h3>
                    <p>We expect and practice a sense of Respect for sentiments of all individuals, concern for all environmental growth and undertake a keen sense of compassion in all of our endeavours. Our emphasis on the practice of this moral code has transformed the personal habits of most of our associates.
                    </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 value-content">
        ...
        <section class="history-sec">
            <div class="container">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-6">
                    <div class="hist-img">
                        <img src="img/passion/work1.jpg" alt="">
                    </div>
                    </div> -->
                </div>
            </div>
