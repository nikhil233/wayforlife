        ...
        <div class="container">
            <div class="flex-wrapper">
                <div class="flex-reg-act">
                    <div class="reg-cont generic-blockquote">
                        <h2>Our Clients </h2>
                        <p class="black-text">Our endeavours would never be as efficient and our efforts would not be as productive without the support of our partners. These are a few of our clients who have been a constant source of support for all of Way for Life’s activities.
                        </p>
                    </div>
                    <div class="reg-img">
